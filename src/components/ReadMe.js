...
function ReadMe() {
  return (
    <StyledReadMe>
      ...
      <p>Welcome to my project! Please refer to my <a href="https://github.com/slampham/10x-Dev" target="_blank" rel="noreferrer">README</a> on GitHub for a more in-depth analysis on this project. This page is just a guide to navigating the website.</p>
      <h1 id="github-facts"><a href="https://ghtorrent.org/relational.html" target="_blank" rel="noreferrer">GITHUB FACTS</a></h1>
      ...
      <h1 id="code-complexity"><a href="https://radon.readthedocs.io/en/latest/intro.html" target="_blank" rel="noreferrer">CODE COMPLEXITY</a></h1>
